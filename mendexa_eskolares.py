...
# --- 2. IZENBURUAK (Actualizado: Árboles y tirolina) ---
...
with col_input:
    ...
    # DETALLES EXTRA DEL DOSSIER
    with st.expander("ℹ️ Informazio Baliagarria / Información de Interés"):
        st.markdown("""
        * **Zer barne dago?**: Monitoreak, aseguruak, beharrezko material guztia eta instalazioen erabilera (komunak barne) [cite: 157-160].
        * **Jantziak**: Arropa erosoa eta kirol oinetako itxiak (debekatuta sandaliak). Ile luzea jasoa eta poltsikoak hutsik [cite: 189-194].
        * **Eguraldia**: Jarduera euriarekin egin daiteke. Haize indartsua edo ekaitza badago, parkeko arduradunek erabakiko dute [cite: 179-180].
        * **Ordutegia**: Txandak mailakatuak dira (9:00etatik aurrera). Zuen beharretara egokitzen gara [cite: 168-170].
        """)
...
with col_result:
    ...
    st.write(f"🎁 **Doako irakasleak:** {profes_gratis} plaza [cite: 232]")
    ...
    if nombre_escuela == "":
        ...
        <div style="border: 5px solid #2E7D32; border-radius: 15px; padding: 25px; background-color: #fcfcfc; font-family: sans-serif; box-shadow: 10px 10px 20px rgba(0,0,0,0.05);">
            ...
            <div style="text-align: right; border-top: 2px solid #2E7D32; padding-top: 15px;">
                ...
                <p style="font-size: 0.8em; color: #888; margin-top: 5px;">BEZ %10 barne / IVA 10% incluido [cite: 161]</p>
            </div>
        </div>
        """
        ...
        # MAILTO para pruebas (solo ikerlarrap@gmail.com)
