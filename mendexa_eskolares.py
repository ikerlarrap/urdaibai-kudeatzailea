...
with col_input:
    ...
    st.write("Idatzi ikasle kopurua programa bakoitzean:")
...
with col_result:
    ...
    # Tramos de precio según el total de alumnos (Web oficial 2025-26)
    ...
    for titulo, num in alumnos_por_programa.items():
        if num > 0:
            ...
            # Construcción del listado de lo elegido
            listado_resumen_html += f"""
                <div style='margin-bottom: 12px; border-left: 4px solid #4CAF50; padding-left: 10px;'>
    ...
    # Gratuidades (1 profesor por cada 10 alumnos)
    ...
    if tier == 3:
        st.success("✅ Talde handiko tarifa aplikatu da (>29).")
...
if st.button("Aurrekontua Sortu / Generar Resguardo", type="primary"):
    if nombre_escuela == "":
        ...
        # EL LISTADO DE LO ELEGIDO DENTRO DEL TICKET
        ticket_html = f"""
