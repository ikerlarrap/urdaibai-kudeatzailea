...
# --- 2. TITULOS ---
st.title("Mendexa Abentura Park: Ikastetxeentzat Aurrekontu Kalkulagailua / Calculadora para Centros Escolares 🌲🌲🧗")
...
with col_input:
    ...
    # Descripciones mejoradas bilingües
    info_programak = {
        "🟡 1 ZIRKUITUA / CIRCUITO: YOKO SOILIK (Adina / Edad: 4-8 urte/años)": {
            "id": "yoko", "cat": "yoko", 
            "desc": "3 itzuli YOKO zirkuituan (Guztira 5 zirkuitu). / 3 vueltas en circuito YOKO (Total 5 circuitos).\n\n📏 Altuera / Altura min.: > 1,10m"
        },
        "🟢 🟢 2 ZIRKUITU / CIRCUITOS (Adina / Edad: >9 urte/años)": {
            "id": "2c_9", "cat": "2c", 
            "desc": "2 itzuli zirkuitu BERDEETAN (Guztira 4 zirkuitu). / 2 vueltas en circuitos VERDES (Total 4 circuitos).\n\n📏 Altuera / Altura min.: > 1,40m"
        },
        "🟢 🔵 2 ZIRKUITU / CIRCUITOS (Adina / Edad: >12 urte/años)": {
            "id": "2c_12", "cat": "2c", 
            "desc": "Zirkuitu BERDEA + URDINA (Guztira 4 zirkuitu). / Circuito VERDE + AZUL (Total 4 circuitos).\n\n📏 Altuera / Altura min.: > 1,50m"
        },
        "🟢 🔵 🔵 3 ZIRKUITU / CIRCUITOS (Adina / Edad: 12-14 urte/años)": {
            "id": "3c_12", "cat": "3c", 
            "desc": "Zirkuitu BERDEA + 2 itzuli URDINEAN (Guztira 5 zirkuitu). / Circuito VERDE + 2 vueltas en AZUL (Total 5 circuitos).\n\n📏 Altuera / Altura min.: > 1,50m"
        },
        "🟢 🔵 🔴 3 ZIRKUITU / CIRCUITOS (Adina / Edad: >15 urte/años)": {
            "id": "3c_15", "cat": "3c", 
            "desc": "Zirkuitu BERDEA + URDINA + GORRIA (Guztira 5 zirkuitu). / Circuito VERDE + AZUL + ROJO (Total 5 circuitos).\n\n📏 Altuera / Altura min.: > 1,50m"
        }
    }
    ...
    # --- INFORMACIÓN DEL DOSSIER ACTUALIZADA BILINGÜE ---
    ...
    with st.expander("Irakurri baldintzak / Leer condiciones del dossier", expanded=False):
        ...
        with col_inf1:
            st.markdown("""
            **🎒 Zer ekarri / Qué traer:**
            * Kirol-arropa erosoa. / Ropa deportiva cómoda.
            * Kirol-oinetako itxiak (sandaliak debekatuta). / Calzado deportivo cerrado (sandalias prohibidas).
            * Ile luzea jasota eraman behar da. / El pelo largo debe ir recogido.
            * Poltsikoak hutsik jardueran zehar. / Bolsillos vacíos durante la actividad.
            
            <br>
            
            **📏 Altuerak / Alturas mínimas:**
            * Yoko zirkuitua: > 1,10 m
            * Zirkuitu Berdea / Circuito Verde: > 1,40 m
            * Zirkuitu Urdina-Gorria / Circuito Azul-Rojo: > 1,50 m
            """, unsafe_allow_html=True)
        with col_inf2:
            st.markdown("""
            **🌦️ Eguraldia eta Ordutegia / Meteorología y Horario:**
            * Euriarekin jarduera egin daiteke. / La actividad se puede realizar con lluvia.
            * Segurtasunagatik (ekaitza/haizea) parkeak jarduera bertan behera utzi dezake. / Por seguridad (tormenta/viento) el parque puede cancelar la actividad.
            * 15 minutu lehenago heltzea gomendatzen da. / Se recomienda llegar 15 minutos antes.
            """)

    with st.expander("ℹ️ Zer dago barne? / ¿Qué incluye?"):
        st.markdown("* Monitoreak, aseguruak eta materiala barne. Arropa erosoa eta oinetako itxiak beharrezkoak dira. / Monitores, seguros y material incluido. Ropa cómoda y calzado deportivo cerrado son necesarios.")
    ...
    if total_alumnos == 0:
        ...
        <div style="display: flex; justify-content: space-between; margin-bottom: 15px; font-family: sans-serif;">
            <div style="background-color: {b1}; color: white; padding: 8px 5px; border-radius: 5px; font-size: 0.85em; text-align: center; width: 32%; font-weight: bold;">
                10-19 ikasle/alumnos<br><small style="font-weight: normal;">Tarifa Normala / Normal</small>
            </div>
            <div style="background-color: {b2}; color: white; padding: 8px 5px; border-radius: 5px; font-size: 0.85em; text-align: center; width: 32%; font-weight: bold;">
                20-29 ikasle/alumnos<br><small style="font-weight: normal;">-1€ Deskontua / Dto.</small>
            </div>
            <div style="background-color: {b3}; color: white; padding: 8px 5px; border-radius: 5px; font-size: 0.85em; text-align: center; width: 32%; font-weight: bold;">
                +29 ikasle/alumnos<br><small style="font-weight: normal;">-2€ Deskontua / Dto.</small>
            </div>
        </div>
        """, unsafe_allow_html=True)
